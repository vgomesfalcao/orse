  ...
  public function getTweets(){
    ...
    foreach ($my_tweets as $key => $value) {
      if(isset($my_tweets->errors)){           
        ...
        //output custom here
        $tweetout .= '<div class="sca_reviews_item"><span>
        '.$this->twitter_time($created).'</span>'.$this->makeClickableLinks($status).'</div>';
      }
    }
    return '<div class="sca_team_slider_single scalac_twitter_block">' . $tweetout . '</div>' ;
  }
