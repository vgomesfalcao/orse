...
class FlickrWidget extends BlockBase {
  ...
  public function build() {
    ...
    $out = '<div class="clearfix margin-bottom-1"></div> <ul id="flickr-5708711ee1be7" class="instagram-feeds row-gallery thumbs" data-id="'.$flickr_id.'" data-count="'.$flickr_photos_count.'">
            </ul>';
    return [
      '#markup' => $out,
      '#attached' => array(
