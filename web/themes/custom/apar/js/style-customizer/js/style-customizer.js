...
$('.sc-variable').change(function(e) {
	...
	if(this.dataset.key == 'colorSecondary'){
		$('.section-secondary').css("background-color", this.value);
	} else if(this.dataset.key == 'colorPrimary') {
		$('.section-primary').css("background-color", this.value);
	}
