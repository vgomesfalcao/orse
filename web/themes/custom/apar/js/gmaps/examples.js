$(function()
{
	var apar_theme_path = $('#apar-theme-path').attr('data-apar-theme-path');
	var image_1 = apar_theme_path+'/js/gmaps/images/gmap-pin-red.png';
	var image_2 = apar_theme_path+'/js/gmaps/images/gmap-pin-green.png';
	var image_3 = apar_theme_path+'/js/gmaps/images/gmap-pin-blue.png';
	var lat = $('#apar-map').data('lat');
   	var lang = $('#apar-map').data('lang');
   $('#map').gMap();
