...
// Returns the private 'mautic.dashboard.model.dashboard' shared service.
...
$this->services['mautic.dashboard.model.dashboard'] = $instance = new \Mautic\DashboardBundle\Model\DashboardModel($a, ${($_ = isset($this->services['mautic.helper.paths']) ? $this->services['mautic.helper.paths'] : $this->getMautic_Helper_PathsService()) && false ?: '_'}, ${($_ = isset($this->services['symfony.filesystem']) ? $this->services['symfony.filesystem'] : ($this->services['symfony.filesystem'] = new \Symfony\Component\Filesystem\Filesystem())) && false ?: '_'});
