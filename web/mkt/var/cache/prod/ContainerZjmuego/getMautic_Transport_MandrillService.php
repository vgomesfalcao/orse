...
// Returns the private 'mautic.transport.mandrill' shared service.

$this->services['mautic.transport.mandrill'] = $instance = new \Mautic\EmailBundle\Swiftmailer\Transport\MandrillTransport(${($_ = isset($this->services['translator.default']) ? $this->services['translator.default'] : $this->getTranslator_DefaultService()) && false ?: '_'}, ${($_ = isset($this->services['mautic.email.model.transport_callback']) ? $this->services['mautic.email.model.transport_callback'] : $this->load('getMautic_Email_Model_TransportCallbackService.php')) && false ?: '_'});
