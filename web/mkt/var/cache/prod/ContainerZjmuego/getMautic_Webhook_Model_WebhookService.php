...
// Returns the private 'mautic.webhook.model.webhook' shared service.
...
$this->services['mautic.webhook.model.webhook'] = $instance = new \Mautic\WebhookBundle\Model\WebhookModel($a, ${($_ = isset($this->services['jms_serializer']) ? $this->services['jms_serializer'] : $this->load('getJmsSerializerService.php')) && false ?: '_'}, ${($_ = isset($this->services['mautic.webhook.http.client']) ? $this->services['mautic.webhook.http.client'] : $this->load('getMautic_Webhook_Http_ClientService.php')) && false ?: '_'}, $b);
