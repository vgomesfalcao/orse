 ...
 */
class AccessToken extends \Mautic\ApiBundle\Entity\oAuth1\AccessToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'consumer', 'user', 'token', 'secret', 'expiresAt'];
        }
