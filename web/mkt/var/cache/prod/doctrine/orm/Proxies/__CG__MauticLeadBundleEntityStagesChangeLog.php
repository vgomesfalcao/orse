 ...
 */
class StagesChangeLog extends \Mautic\LeadBundle\Entity\StagesChangeLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\StagesChangeLog' . "\0" . 'id', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\StagesChangeLog' . "\0" . 'lead', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\StagesChangeLog' . "\0" . 'stage', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\StagesChangeLog' . "\0" . 'eventName', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\StagesChangeLog' . "\0" . 'actionName', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\StagesChangeLog' . "\0" . 'dateAdded'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StagesChangeLog $proxy) {
