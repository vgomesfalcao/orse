...
class Point extends \Mautic\PointBundle\Entity\Point implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'id', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'name', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'description', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'type', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'repeatable', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'publishUp', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'publishDown', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'delta', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'properties', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'log', '' . "\0" . 'Mautic\\PointBundle\\Entity\\Point' . "\0" . 'category', 'changes', 'new', 'deletedId', 'pastChanges'];
        }
