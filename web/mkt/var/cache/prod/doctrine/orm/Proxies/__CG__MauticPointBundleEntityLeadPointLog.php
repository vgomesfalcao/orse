 ...
 */
class LeadPointLog extends \Mautic\PointBundle\Entity\LeadPointLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\PointBundle\\Entity\\LeadPointLog' . "\0" . 'point', '' . "\0" . 'Mautic\\PointBundle\\Entity\\LeadPointLog' . "\0" . 'lead', '' . "\0" . 'Mautic\\PointBundle\\Entity\\LeadPointLog' . "\0" . 'ipAddress', '' . "\0" . 'Mautic\\PointBundle\\Entity\\LeadPointLog' . "\0" . 'dateFired'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LeadPointLog $proxy) {
