...
class LeadList extends \Mautic\LeadBundle\Entity\LeadList implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadList' . "\0" . 'id', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadList' . "\0" . 'name', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadList' . "\0" . 'publicName', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadList' . "\0" . 'description', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadList' . "\0" . 'alias', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadList' . "\0" . 'filters', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadList' . "\0" . 'isGlobal', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadList' . "\0" . 'isPreferenceCenter', '' . "\0" . 'Mautic\\LeadBundle\\Entity\\LeadList' . "\0" . 'leads', 'changes', 'new', 'deletedId', 'pastChanges'];
        }
