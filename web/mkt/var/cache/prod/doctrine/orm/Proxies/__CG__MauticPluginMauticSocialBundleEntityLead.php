 ...
 */
class Lead extends \MauticPlugin\MauticSocialBundle\Entity\Lead implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MauticPlugin\\MauticSocialBundle\\Entity\\Lead' . "\0" . 'monitor', '' . "\0" . 'MauticPlugin\\MauticSocialBundle\\Entity\\Lead' . "\0" . 'lead', '' . "\0" . 'MauticPlugin\\MauticSocialBundle\\Entity\\Lead' . "\0" . 'dateAdded'];
        }
