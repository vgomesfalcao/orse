...
class Copy extends \Mautic\EmailBundle\Entity\Copy implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Copy' . "\0" . 'id', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Copy' . "\0" . 'dateCreated', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Copy' . "\0" . 'body', '' . "\0" . 'Mautic\\EmailBundle\\Entity\\Copy' . "\0" . 'subject'];
        }
