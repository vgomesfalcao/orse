 ...
 */
class LeadTriggerLog extends \Mautic\PointBundle\Entity\LeadTriggerLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\PointBundle\\Entity\\LeadTriggerLog' . "\0" . 'event', '' . "\0" . 'Mautic\\PointBundle\\Entity\\LeadTriggerLog' . "\0" . 'lead', '' . "\0" . 'Mautic\\PointBundle\\Entity\\LeadTriggerLog' . "\0" . 'ipAddress', '' . "\0" . 'Mautic\\PointBundle\\Entity\\LeadTriggerLog' . "\0" . 'dateFired'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LeadTriggerLog $proxy) {
