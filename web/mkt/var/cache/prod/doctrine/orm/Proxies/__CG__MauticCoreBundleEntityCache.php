 ...
 */
class Cache extends \Mautic\CoreBundle\Entity\Cache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Mautic\\CoreBundle\\Entity\\Cache' . "\0" . 'id', '' . "\0" . 'Mautic\\CoreBundle\\Entity\\Cache' . "\0" . 'data', '' . "\0" . 'Mautic\\CoreBundle\\Entity\\Cache' . "\0" . 'lifetime', '' . "\0" . 'Mautic\\CoreBundle\\Entity\\Cache' . "\0" . 'time'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cache $proxy) {
